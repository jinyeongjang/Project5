  ...
  return (
    <div className="container mx-auto mt-[100px] flex px-4 py-8 xs:mt-[50px] xs:flex-col">
            ...
            <div className="flex items-start gap-8 xs:flex-col xs:gap-2">
              <div className="order-2 flex gap-1 xs:order-2 xs:justify-center">
                <div className="relative flex flex-col items-center">
                  <motion.img
                    src="/images/kiosk/androidminipos/minipos_stand01.png"
                    alt="KIS 안드로이드 미니포스 정면-1"
                    className="h-[200px] w-[200px] rounded-xl object-contain xs:h-[250px] xs:w-[125px]"
                    variants={itemVariants}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_stand01.png')}
                  ...
                  <p className="mt-2 text-center text-sm text-gray-600">KIS 안드로이드 미니포스 모델</p>
                </div>
                <div className="relative flex flex-col items-center">
                  <motion.img
                    src="/images/kiosk/androidminipos/minipos_stand02.png"
                    alt="KIS 안드로이드 미니포스 정면-2"
                    className="h-[200px] w-[200px] rounded-xl object-contain xs:h-[250px] xs:w-[125px]"
                    variants={itemVariants}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_stand02.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                    <IoSearchOutline size={20} />
                  </button>
                  <p className="mt-2 text-center text-sm text-gray-600">KIS 안드로이드 미니포스 모델</p>
            ...
            <motion.div className="mt-12 xs:mt-8" variants={itemVariants}>
              ...
              <div className="grid grid-cols-1 gap-4 xs:gap-2">
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/androidminipos/minipos_01.png"
                    alt="KIS 안드로이드 미니포스 키오스크 상세"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_01.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_01.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/androidminipos/minipos_02.png"
                    alt="KIS 안드로이드 미니포스 키오스크 상세"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_02.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_02.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/androidminipos/minipos_03.png"
                    alt="KIS 안드로이드 미니포스 키오스크 상세"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_03.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/minipos_03.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/androidminipos/androidminipos_spec.png"
                    alt="KIS 안드로이드 미니포스 키오스크 상세"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/androidminipos_spec.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/androidminipos/androidminipos_spec.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
      ...
      <ModalImage
        ...
        alt="KIS 안드로이드 미니포스 키오스크 상세 이미지"
      />
    </div>
  );
};

export default KioskKisAndroidminipos;
