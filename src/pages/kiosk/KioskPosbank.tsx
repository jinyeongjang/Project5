  ...
  return (
    <div className="container mx-auto mt-[100px] flex px-4 py-8 xs:mt-[50px] xs:flex-col">
            ...
            <div className="flex items-start gap-8 xs:flex-col xs:gap-2">
              <div className="order-2 flex gap-1 xs:order-2 xs:justify-center">
                <div className="relative flex flex-col items-center">
                  <motion.img
                    src="/images/kiosk/posbank/posbankbigpos.png"
                    alt="포스뱅크 키오스크 정면"
                    className="h-[200px] w-[200px] rounded-xl object-contain xs:h-[250px] xs:w-[125px]"
                    variants={itemVariants}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos.png')}
                  ...
                  <p className="mt-3 text-center text-sm text-gray-600 sm:text-sm xs:text-xs">포스뱅크 빅포스 모델</p>
                </div>
              </div>
              <div className="order-1 flex-1 xs:order-1 xs:text-center">
                <motion.h1
                  className="mb-4 text-left text-[45px] font-bold text-blue-600 xs:text-center xs:text-[28px]"
                  variants={itemVariants}>
                  포스뱅크 빅포스
                </motion.h1>
                <motion.p
                  className="mb-4 text-left text-4xl font-bold text-gray-800 xs:text-center xs:text-2xl"
                  variants={itemVariants}>
                  최신 고성능 프로세서를 <br className="xs:hidden" />
                  탑재한 키오스크
                </motion.p>
              </div>
            </div>
            ...
            <motion.div className="mt-12 xs:mt-8" variants={itemVariants}>
              ...
              <div className="grid grid-cols-1 gap-4 xs:gap-2">
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/posbank/posbankbigpos2.png"
                    alt="포스뱅크 빅포스 키오스크 상세 1"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos2.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos2.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/posbank/posbankbigpos3.png"
                    alt="포스뱅크 빅포스 키오스크 상세 2"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos3.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos3.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/posbank/posbankbigpos4.png"
                    alt="포스뱅크 빅포스 키오스크 상세 3"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos4.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos4.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/posbank/posbankbigpos5.png"
                    alt="포스뱅크 빅포스 키오스크 상세 4"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos5.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankbigpos5.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/kiosk/posbank/posbankspecdetail.png"
                    alt="포스뱅크 빅포스 키오스크 상세 4"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankspecdetail.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/kiosk/posbank/posbankspecdetail.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
      ...
      <ModalImage
        ...
        alt="포스뱅크 빅포스 키오스크 상세 이미지"
      />
    </div>
  );
};

export default KioskPosbank;
