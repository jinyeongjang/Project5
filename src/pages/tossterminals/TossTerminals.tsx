            ...
            <div className="flex items-start gap-8 xs:flex-col xs:gap-2">
              <div className="order-2 flex gap-1 xs:order-2 xs:justify-center">
                ...
                <div className="relative flex flex-col items-center">
                  <motion.img
                    src="/images/tossterminals/tossterminals.png"
                    alt="토스 터미널 정면"
                    className="h-[200px] w-[200px] rounded-xl object-contain xs:h-[250px] xs:w-[125px]"
                    variants={itemVariants}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/tossterminals/tossterminals.png')}
            ...
            <motion.div className="mt-12 xs:mt-8" variants={itemVariants}>
              ...
              <div className="grid grid-cols-1 gap-4 xs:gap-2">
                <div className="relative">
                  <motion.img
                    src="/images/tossterminals/tosstermainalsdetail1.png"
                    alt="토스 단말기 상세 이미지 1"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/tossterminals/tosstermainalsdetail1.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/tossterminals/tosstermainalsdetail1.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/tossterminals/tossterminalsdetail2.png"
                    alt="토스 단말기 상세 이미지 2"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/tossterminals/tossterminalsdetail2.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/tossterminals/tossterminalsdetail2.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/tossterminals/tossterminalsdetail3.png"
                    alt="토스 단말기 상세 이미지 3"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/tossterminals/tossterminalsdetail3.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/tossterminals/tossterminalsdetail3.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    ...
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/tossterminals/tosscollabo2.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/tossterminals/tosscollabo2.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/tossterminals/tosscollabo1.png"
                    alt="토스 단말기 상세 이미지 4"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/tossterminals/tosscollabo1.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/tossterminals/tosscollabo1.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
              ...
              <div className="relative">
                <motion.img
                  src="/images/tossterminals/tossterminalsspec.png"
                  alt="토스 터미널 스펙 이미지"
                  className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                  variants={itemVariants}
                  onClick={() => setSelectedImage('/images/tossterminals/tossterminalsspec.png')}
                />
                <button
                  onClick={() => setSelectedImage('/images/tossterminals/tossterminalsspec.png')}
                  className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
