            ...
            <div className="flex items-start gap-8 xs:flex-col xs:gap-2">
              ...
              <div className="order-2 flex gap-1 xs:order-2 xs:justify-center">
                <div className="relative flex flex-col items-center">
                  <motion.img
                    src="/images/wire/3inch/KIS-1421P/1421P_main.png"
                    alt="3인치 KIS-1421P 모델"
                    className="h-[200px] w-[200px] rounded-xl object-contain xs:h-[250px] xs:w-[125px]"
                    variants={itemVariants}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/wire/3inch/KIS-1421P/1421P_main.png')}
                  ...
                  <p className="mt-2 text-center text-sm text-gray-600">3인치 KIS-1421P 모델</p>
                </div>
              </div>
            </div>
            ...
            <motion.div className="mt-12 xs:mt-8" variants={itemVariants}>
              ...
              <div className="grid grid-cols-1 gap-4 xs:gap-2">
                <div className="relative">
                  <motion.img
                    src="/images/wire/3inch/KIS-1421P/1421P_01.png"
                    alt="3인치 KIS-1421P 상세 1"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/wire/3inch/KIS-1421P/1421P_01.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/wire/3inch/KIS-1421P/1421P_01.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/wire/3inch/KIS-1421P/1421P_02.png"
                    alt="3인치 KIS-1421P 상세 2"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/wire/3inch/KIS-1421P/1421P_02.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/wire/3inch/KIS-1421P/1421P_02.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
                ...
                <div className="relative">
                  <motion.img
                    src="/images/wire/3inch/KIS-1421P/KIS-1421_spec.png"
                    alt="3인치 KIS-1421P 스펙"
                    className="w-full cursor-pointer rounded-xl object-contain shadow-lg transition-transform duration-300 hover:scale-105"
                    variants={itemVariants}
                    onClick={() => setSelectedImage('/images/wire/3inch/KIS-1421P/KIS-1421_spec.png')}
                  />
                  <button
                    onClick={() => setSelectedImage('/images/wire/3inch/KIS-1421P/KIS-1421_spec.png')}
                    className="absolute right-2 top-2 rounded-full bg-white/80 p-2 text-gray-800 shadow-lg transition-colors hover:bg-white">
