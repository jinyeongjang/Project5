...
const UnattendAuthSidebar: React.FC = () => {
    ...
    <>
      ...
      <div
        ...
        <div className="mb-4 flex items-center justify-between">
          <h3 className="ml-4 text-left text-lg font-bold text-sky-700">출입인증/CCTV ::</h3>
          <button
...
export default UnattendAuthSidebar;
